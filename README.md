...
-   [Observable HQ](#observable-hq)
    -   [WebGL 绘图（之一）](#webgl绘图之一)
    -   [WebGL 绘图（之三）](#webgl绘图之三)
    -   [WebGL 绘图（之二）](#webgl绘图之二)
    -   [一个简单的动力学模型](#一个简单的动力学模型)
    -   [乌合之众](#乌合之众)
    -   [云雾效果](#云雾效果)
    -   [今天的风儿有些喧嚣](#今天的风儿有些喧嚣)
    -   [像上网一样使用 FSL](#像上网一样使用fsl)
    -   [吹气球](#吹气球)
    -   [在太阳内部航行](#在太阳内部航行)
    -   [将 FSL 统计结果映射到 FreesSurfer 皮层上](#将fsl统计结果映射到freessurfer皮层上)
    -   [无限上升的卡农](#无限上升的卡农)
    -   [日地月-2](#日地月-2)
    -   [日地月](#日地月)
...
-   [Talk with Picture](#talk-with-picture)
    -   [COCO 图像类别空间的简单可视化](#coco图像类别空间的简单可视化)
    -   [Coco 数据集](#coco数据集)
    -   [一种线性反馈的多输出零点控制方式](#一种线性反馈的多输出零点控制方式)
    -   [丙子双十二](#丙子双十二)
    -   [从词向量的角度理解 COCO](#从词向量的角度理解coco)
    -   [商业精神](#商业精神)
    -   [降维打击-四元数](#降维打击-四元数)
    -   [图像的颜色风格化](#图像的颜色风格化)
    -   [图解 FDR](#图解fdr)
